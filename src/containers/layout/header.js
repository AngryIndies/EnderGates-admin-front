        ...
        <ul className="navbar-nav flex-row">
          <li className="nav-item dropdown dropdown-list">
            ...
            <div className="dropdown-menu dropdown-menu-right animated bounceIn">
              ...
              <div className="p-3 text-center">
                <small className="text-primary">READ ALL</small>
              </div>
            </div>
          </li>
          <li className="nav-item dropdown dropdown-list">
                    ...
                    <div className="media">
                      ...
                      <div className="media-body">
                        ...
                        <p className="m-0 text-muted">
                          <small>
                            There are
                            <strong className="mx-1 text-primary">2</strong>new
                            updates available
                          </small>
                        </p>
                      </div>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-right animated bounceIn">
              ...
              <div className="dropdown-item">
                Notifications
                <div className="badge badge-info float-right">5</div>
              </div>
              <div className="dropdown-item">
                Messages<div className="badge badge-danger float-right">10</div>
              </div>
